...
-- CreateEnum
CREATE TYPE "CharacterCategory" AS ENUM ('ROMANTIC', 'FRIENDLY', 'MENTOR', 'ADVENTURE', 'FANTASY', 'SCI_FI', 'LIFESTYLE');
...
-- CreateIndex
CREATE INDEX "Character_isPublished_isFeatured_idx" ON "Character"("isPublished", "isFeatured");
