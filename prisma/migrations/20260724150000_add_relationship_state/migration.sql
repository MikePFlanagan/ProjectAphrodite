...
CREATE UNIQUE INDEX "Relationship_userId_characterId_key"
ON "Relationship"("userId", "characterId");

CREATE INDEX "Relationship_characterId_idx" ON "Relationship"("characterId");

ALTER TABLE "Relationship"
ADD CONSTRAINT "Relationship_userId_fkey"
FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Relationship"
ADD CONSTRAINT "Relationship_characterId_fkey"
