...
export function IdentityEditor({
  ...
  function updateField<
    Key extends keyof CompanionDraft,
  >(
    key: Key,
  ...
  return (
    <div className="mt-8 space-y-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <Field
          label="Tagline"
          hint={`${companion.tagline.length}/100`}
        >
          <input
      ...
      <Field
        label="Description"
        hint={`${companion.description.length}/600`}
      >
        <textarea
      ...
      <Field
        ...
        hint={`${companion.greeting.length}/500`}
      >
        <textarea
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-white/35">
              Add up to six short traits that
              describe this companion.
            </p>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-white/38">
              Changes made here immediately update
              the companion preview on the right.
              Database saving comes in the next
              milestone.
            </p>
          </div>
        </div>
