    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6">
      <nav className="mx-auto flex h-14 max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-[#100c17]/70 px-3 shadow-2xl shadow-black/20 backdrop-blur-xl sm:px-4" aria-label="Primary navigation">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <a href="/signup" className="inline-flex items-center gap-2 rounded-xl bg-white px-3.5 py-2 text-xs font-semibold text-[#160d1e] transition hover:bg-fuchsia-100 sm:text-sm"><Compass className="size-3.5" /> Create account</a>
        </div>
      </nav>
    </header>
  );
